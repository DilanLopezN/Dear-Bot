...
export class BotService {
  ...
  async create(userId: string, dto: CreateBotDto) {
    ...
    try {
      ...
      this.logger.error(`Erro ao criar bot para usuário ${userId}: ${err.message}`, err.stack);
      throw err;
    }
  }
  ...
  async findAll(userId: string) {
    ...
    try {
      ...
      this.logger.error(`Erro ao listar bots do usuário ${userId}: ${err.message}`, err.stack);
      throw err;
    }
  }
  ...
  async getDashboardOverview(userId: string) {
    ...
    try {
      ...
      this.logger.error(`Erro ao buscar dashboard overview do usuário ${userId}: ${err.message}`, err.stack);
      throw err;
    }
  }
  ...
  async getReportsAnalytics(userId: string) {
    ...
    try {
      ...
      this.logger.error(`Erro ao buscar relatórios do usuário ${userId}: ${err.message}`, err.stack);
      throw err;
    }
  }
  ...
  async getMonthlyMetrics(userId: string) {
    ...
    try {
      ...
      this.logger.error(`Erro ao buscar métricas mensais do usuário ${userId}: ${err.message}`, err.stack);
      throw err;
    }
  }
  ...
  async findOne(userId: string, botId: string) {
    ...
    try {
      ...
      this.logger.error(`Erro ao buscar bot ${botId}: ${err.message}`, err.stack);
      throw err;
    }
  }
  ...
  async update(userId: string, botId: string, dto: UpdateBotDto) {
    ...
    try {
      ...
      if (err instanceof NotFoundException || err instanceof ForbiddenException) throw err;
      this.logger.error(`Erro ao atualizar bot ${botId}: ${err.message}`, err.stack);
      throw err;
    }
  }
  ...
  async remove(userId: string, botId: string) {
    ...
    try {
      ...
      if (err instanceof NotFoundException || err instanceof ForbiddenException) throw err;
      this.logger.error(`Erro ao remover bot ${botId}: ${err.message}`, err.stack);
      throw err;
    }
  }
}
